...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println();
        //TIP run time polymorphism (dynamic method dispatch) using method overriding. Its the JVM's responsibility to call the correct method depending on the Object type at run time while the compiler should make sure that the method already exists in the reference type object at compile time.
